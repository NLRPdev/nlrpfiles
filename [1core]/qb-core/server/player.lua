...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    PlayerData.metadata['cocainexp'] = PlayerData.metadata['cocainexp'] or 0
    PlayerData.metadata['heoinxp'] = PlayerData.metadata['heoinxp'] or 0
    PlayerData.metadata['methxp'] = PlayerData.metadata['methxp'] or 0
