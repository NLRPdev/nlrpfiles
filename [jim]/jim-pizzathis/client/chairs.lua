...
CreateThread(function()
	for k, v in pairs(Config.Chairs) do
		Chairs["PizzChair"..k] =
		exports['qb-target']:AddBoxZone("PizzChair"..k, v.location, v.width, v.depth, { name="PizzChair"..k, heading = v.heading, debugPoly=Config.Debug, minZ = v.minZ, maxZ = v.maxZ, }, 
			{ options = { { event = "jim-pizzathis:Chair", icon = "fas fa-chair", label = "Sit Down", loc = v.location, head = v.heading, seat = v.seat }, },
