...
Config.Stores = {
    [1] = {shopType = 'clothing', coords = vector3(1690.68, 4824.98, 42.07), width = 15, length = 15},
    [2] = {shopType = 'clothing', coords = vector3(-710.85, -153.39, 37.42), width = 15, length = 15},
    [3] = {shopType = 'clothing', coords = vector4(-1194.87, -772.87, 17.32, 126), width = 15, length = 15},
    [4] = {shopType = 'clothing', coords = vector3(425.236, -806.008, 29.491), width = 15, length = 15},
    [5] = {shopType = 'clothing', coords = vector3(-162.658, -303.397, 39.733), width = 15, length = 15},
    [6] = {shopType = 'clothing', coords = vector3(75.950, -1392.891, 29.376), width = 15, length = 15},
    [7] = {shopType = 'clothing', coords = vector3(-822.194, -1074.134, 11.328), width = 15, length = 15},
    [8] = {shopType = 'clothing', coords = vector3(-1450.711, -236.83, 49.809), width = 15, length = 15},
    [9] = {shopType = 'clothing', coords = vector3(4.254, 6512.813, 31.877), width = 15, length = 15},
    [10] = {shopType = 'clothing', coords = vector3(615.180, 2762.933, 42.088), width = 15, length = 15},
    [11] = {shopType = 'clothing', coords = vector3(1196.785, 2709.558, 38.222), width = 15, length = 15},
    [12] = {shopType = 'clothing', coords = vector3(-3171.453, 1043.857, 20.863), width = 15, length = 15},
    [13] = {shopType = 'clothing', coords = vector3(-1100.959, 2710.211, 19.107), width = 15, length = 15},
    [14] = {shopType = 'clothing', coords = vector3(-1207.65, -1456.88, 5.3784737586975), width = 15, length = 15},
    [15] = {shopType = 'clothing', coords = vector3(121.76, -224.6, 54.56), width = 15, length = 15},
    [16] = {shopType = 'barber', coords = vector3(-814.36, -183.72, 37.57), width = 15, length = 5},
    [17] = {shopType = 'barber', coords = vector3(136.8, -1708.4, 29.3), width = 15, length = 5},
    [18] = {shopType = 'barber', coords = vector3(-1282.6, -1116.8, 6.0), width = 10, length = 7},
    [19] = {shopType = 'barber', coords = vector3(1931.5, 3729.7, 32.8), width = 10, length = 7},
    [20] = {shopType = 'barber', coords = vector3(1212.8, -472.9, 66.2), width = 10, length = 7},
    [21] = {shopType = 'barber', coords = vector3(-32.9, -152.3, 57.1), width = 10, length = 7},
    [22] = {shopType = 'barber', coords = vector3(-278.1, 6228.5, 30.7), width = 10, length = 7}
}
