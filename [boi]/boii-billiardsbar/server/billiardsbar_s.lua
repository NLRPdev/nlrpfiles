                        ...
                        if fruit.amount >= IngredientAmount then
                            ...
                            if fruit2 ~= nil then
                                if fruit2.amount >= IngredientAmount then
                                    ...
                                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughorange'], 'error')
                            ...
                            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughlemon'], 'error')
                            TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 1)
                        end
                    else
                        TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nolemon'], 'error')
                        TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 1)
                    end
                else
                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughwhiskey'], 'error')
                    TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 1)
                end
            else
                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nowhiskey'], 'error')
                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 1)
            end
		else
			TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nococktailglass'], 'error')
			TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 1)
		end
    elseif args == 2 then 
        local glass = Player.Functions.GetItemByName('cocktailglass') 
                        ...
                        if fruit.amount >= IngredientAmount then
                            ...
                            if fruit2 ~= nil then
                                if fruit2.amount >= IngredientAmount then
                                    ...
                                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughapple'], 'error')
                                    TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 1)
                                end
                            else
                                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughapple'], 'error')
                    ...
                    if fruit ~= nil then
                        if fruit.amount >= IngredientAmount2 then
                            ...
                            if fruit2 ~= nil then
                                ...
                                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['noorange'], 'error')
                                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 1)
                            end
                        else
                            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughlemon'], 'error')
                        ...
                        if fruit.amount >= IngredientAmount then
                            ...
                            if fruit2 ~= nil then
                                if fruit2.amount >= IngredientAmount then
                                    ...
                                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughcocomilk'], 'error')
                                    TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
                                end
                            else
                                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nococomilk'], 'error')
                                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
                            end
                        else
                            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughpineapple'], 'error')
                            TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
                        end
                    else
                        TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nopineapple'], 'error')
                        TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
                    end
                else
                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughrum'], 'error')
                    TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
                end
            else
                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['norum'], 'error')
                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
            end
        else
            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nococktailglass'], 'error')
                ...
                if liquor.amount >= liquorAmount then
                    ...
                    if fruit ~= nil then
                        if fruit.amount >= IngredientAmount then
                            ...
                            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughlime'], 'error')
                            TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
                        end
                    else
                        TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nolime'], 'error')
                        TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 2)
                    end
                else
                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughrum'], 'error')
        ...
        if glass ~= nil then
            ...
            if liquor ~= nil then
                if liquor.amount >= liquorAmount then
                    ...
                    if fruit ~= nil then
                        if fruit.amount >= IngredientAmount then
                            ...
                            if fruit2 ~= nil then
                                ...
                                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['noapple'], 'error')
                                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 3)
                            end
                        else
                            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughlemon'], 'error')
                    ...
                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughvodka'], 'error')
                    TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 3)
                end
            else
                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['novodka'], 'error')
                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 3)
            end
        else
            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nococktailglass'], 'error')
                        ...
                        if fruit.amount >= IngredientAmount then
                            ...
                            if fruit2 ~= nil then
                                if fruit2.amount >= IngredientAmount3 then
                                    ...
                                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughcranberry'], 'error')
                                    TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 3)
                                end
                            else
                                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nocranberry'], 'error')
                                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 3)
                            end
                        else
                            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughlime'], 'error')
                        ...
                        if fruit.amount >= IngredientAmount then
                            ...
                            if fruit2 ~= nil then
                                if fruit2.amount >= IngredientAmount2 then
                                    ...
                                    TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughtomato'], 'error')
                                    TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 3)
                                end
                            else
                                TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['notomato'], 'error')
                                TriggerClientEvent('boii-billiardsbar:client:CocktailsMenu', source, 3)
                            end
                        else
                            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['enoughlemon'], 'error')
...
RegisterServerEvent('boii-billiardsbar:server:HotDrinks', function(args) 
    ...
    if args == 1 then 
        ...
        if cup ~= nil then           
            ...
            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nocup'], 'error')
...
RegisterServerEvent('boii-billiardsbar:server:MicrowaveFood', function(args) 
    ...
    if args == 1 then 
        ...
        if food ~= nil then           
            ...
            TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nofood'], 'error')
...
RegisterNetEvent("boii-billiardsbar:server:ReturnDeposit", function()
	...
	TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['returnedvan'], 'success')
end) 
Core.Functions.CreateCallback('boii-billiardsbar:server:MoneyCheck', function(source, cb)
    ...
    if bankBalance >= price then
        ...
        TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['rentedvan'], 'success')
        cb(true)
    else
        TriggerClientEvent('boii-billiardsbar:notifications', source, Config.Lang['nomoney'], 'error')
        cb(false)
    end
end)
