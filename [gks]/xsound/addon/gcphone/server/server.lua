if config.AddonList.gksphone then
    ...
    AddEventHandler('muzik-cal', function(muzikAdi, link, mp3)
        TriggerClientEvent("client-muzik-cal", -1, source, GetEntityCoords(GetPlayerPed(source)),  muzikAdi, link, mp3)
    end)
