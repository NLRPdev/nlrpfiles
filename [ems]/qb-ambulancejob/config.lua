...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
        ...
        [2] = vector3(311.83, -593.25, 44.36),
	    [3] = vector3(-254.54, 6331.78, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(303.69, -600.69, 43.28),
    ...
    ["main"] = {
        [1] = vector3(332.31, -595.71, 43.28),
    },
    ["stash"] = {
        [1] = vector3(306.86, -601.86, 43.28),
    },
    ["beds"] = {
        [1] = {coords = vector4(324.14, -582.79, 44.20, 153), taken = false, model = 1631638868},
        [2] = {coords = vector4(322.48, -587.28, 44.20, 341), taken = false, model = 1631638868},
        [3] = {coords = vector4(317.75, -585.21, 44.20, 343), taken = false, model = 2117668672},
        [4] = {coords = vector4(319.35, -580.98, 44.20, 157), taken = false, model = 2117668672},
        [5] = {coords = vector4(314.49, -584.12, 44.20, 335), taken = false, model = 2117668672},
        [6] = {coords = vector4(313.89, -579.09, 44.20, 158), taken = false, model = -1091386327},
        [7] = {coords = vector4(311.11, -582.99, 44.20, 338), taken = false, model = -1091386327},
        [8] = {coords = vector4(309.29, -577.57, 44.20, 155), taken = false, model = -1091386327},
	--- paleto
    ...
    ["jailbeds"] = {
        [1] = {coords = vector4(1771.97, 2597.95, 46.66, 89), taken = false, model = 2117668672},
        [2] = {coords = vector4(1761.72, 2597.75, 46.66, 270), taken = false, model = 2117668672},
        [3] = {coords = vector4(1761.99, 2594.61, 46.66, 268), taken = false, model = 2117668672},
        [4] = {coords = vector4(1772.02, 2594.90, 46.66, 90), taken = false, model = 2117668672},
        [5] = {coords = vector4(1772.00, 2591.74, 46.66, 94), taken = false, model = 2117668672},
        [6] = {coords = vector4(1761.86, 2591.51, 46.66, 263), taken = false, model = 2117668672},
    },
    ["stations"] = {
