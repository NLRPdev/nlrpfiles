...
-- This function will return the amount of money in the player's wallet
...
-- This function will remove money from the player's wallet
function removeWalletMoney(source, value)
    -- local xPlayer = ESX.GetPlayerFromId(source)

    -- if xPlayer then
    --     xPlayer.removeAccountMoney('money', value)
    -- end 
end
