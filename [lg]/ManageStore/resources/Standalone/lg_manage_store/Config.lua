...
stores = {
    ...
    --     coordinates = {
	--			{
    --          	buy_items = vector3(130.74, 1166.902, 231.59),
    --          	buy_store = vector3(136.74, 1166.902, 231.59),
    --          	mission = vector3(140.74, 1166.902, 231.59),
	--			},
    -- 
    --     },

    --     items = {
    --          {name = "handcuffs", label = "Handcuffs", amount = 500, weight = 1.0, price = 152, recommended_price = 100, max_price = 1000, request_price = 50, mission_money = 25, max_request = 500},
    --          {name = "mask", label = "Mask", amount = 500, weight = 1.0, price = 100, recommended_price = 100, max_price = 1000, request_price = 50, mission_money = 25, max_request = 500},
...
--      
    --      color_header = "rgb(46, 46, 46)",   -- color of store header
