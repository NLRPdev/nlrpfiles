        ...
        <div id="PopUpBox" v-if="popUp">
            <div id="PopUp">
                <div id="PopAlert" v-if="step == 'sell'">
                    ...
                    <p class="PopUpMessage">{{translate.TR_CONFIR_SELL_MESSAGE}} {{(price_store - (price_store*(percentage_sell/100.0))).toFixed(2)}}</p>
                    <div id="PopUpButtons">
                        <p id="PopUpButtonGreen" :style="StyleBody" @click="SendSellStore">{{translate.TR_YES}}</p>
        ...
        <div id="StoreBodyBox" :class="{blur: popUp}" :style="StyleHeader">
            ...
            <div id="StoreBox">
                ...
                <div id="StoreContentBox">
                    <div>
                        <div id="CartTitleBox">
                            <p id="CartTitle">{{translate.TR_SELL_STORE}}</p>
                        </div>

                        <div id="BalanceBox">
                            <div id="BalanceImageBox">
                                <img src="img/banner.png" alt="" id="BalanceImage">
                            </div>

                            <div id="BalanceMoneyBox">
                                <p id="SellMoney">{{translate.TR_MONEY_SIMBOL}} {{(price_store - (price_store*(percentage_sell/100.0))).toFixed(2)}}</p>
                                <p id="SellTextConfirm">{{translate.TR_SELL_TEXT}} {{translate.TR_MONEY_SIMBOL}} {{(price_store - (price_store*(percentage_sell/100.0))).toFixed(2)}}. {{translate.TR_SELL_TEXT2}}</p>
                            </div>

                            <div id="BalanceButtonsBox">
                                <p class="BalanceButton" :style="StyleBody" @click="SellStore">{{translate.TR_CONFIRM_SELL}}</p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        SendSellStore: function(){
                ...
                axios.post(`https://${NameResource}/sendSellStore`, {
