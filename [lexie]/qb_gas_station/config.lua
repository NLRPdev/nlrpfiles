...
Config.webhook = "https://discord.com/api/webhooks/998504112444428308/LSQQDzY8DETV97GpVkN-jm5hZ_FDEh2SSQdSz8gXptjQKGgIrtPBx_UQghSgQj5RlioS"						-- Webhook to send logs to discord
Config.lang = "en"								-- Set the file language [en/br]

Config.Framework = {							-- ESX/QBCore settings
...
Config.gas_station_locations = {
	...
	["gas_station_28"] = {
		['buy_price'] = 650000,
		['sell_price'] = 330000,
		['coord'] = {809.88, -790.09, 26.20, 2},
		['truck_coord'] = {785.17, -764.69, 26.49, 2},
		['trailer_coord'] = {784.78, -782.18, 26.37, 356},
		['deliveryman_coord'] = {813.63, -784.99, 26.34, 6},
		['type'] = 'small_gas_station',
	}
}
...
Config.gas_station_types = {
	['small_gas_station'] = {					-- Gas station type ID
		...
		['blips'] = {							-- Create the blips on the map
			...
			['name'] = "Gas station",			-- Blip Name [Will be replaced when the owner rename the store]
			['color'] = 41,						-- Blip Color
